...
class DistilledLabel(DistilledFeature):
    def __init__(
        ...
        label_ids = torch.arange(data_per_label * num_labels) % num_labels  # [0, 1, 0, 1, ...]
...
class DistilledData:
    ...
    def get_batch(self, step):
        ...
        return {
            "inputs_embeds": self.inputs_embeds[indices],   #以sst-2为例，inputs_embeds是一个tensor，shape为(2,512,768)
    ...
    @classmethod
    def from_pretrained(cls, save_path: str | os.PathLike): # cls是
